      ...
      <main className="tab-content" role="main">
        {activeTab === 'overview' && (
          <section className="about">
            <p>Hey! I'm a 2nd year CS undergrad at UCLA w/ roots in NJ. I'm broadly interested in computer systems and theory - right now, I'm spending the most time on C++, microarchitecture, distributed systems, and compilers. If you've got good resources or interesting projects, I'd love to talk.</p>
            <p>This summer, I'll be joining <a href="https://www.citadel.com/" target="_blank" rel="noopener noreferrer" className="inline-link">Citadel</a> as a SWE intern in the Electronic Trading Engineering org, working on execution systems. Later, in the Fall, I'll join <a href="https://openai.com/" target="_blank" rel="noopener noreferrer" className="inline-link">OpenAI</a> as a Member of Technical Staff intern. Previously, I worked on data infra at <a href="https://www.capitalone.com" target="_blank" rel="noopener noreferrer" className="inline-link">Capital One</a> and reasoning models at <a href="https://scale.com" target="_blank" rel="noopener noreferrer" className="inline-link">Scale AI</a>.</p>
            <p>Outside of all that, I'm reading novels and manga (currently finishing <a href="https://www.turtleme.com/tbate-novel" target="_blank" rel="noopener noreferrer" className="inline-link">The Beginning After The End</a>), going down rabbit holes (usually pure math, philosophy, or engineering textbooks and blogs), playing <a href="https://store.steampowered.com/app/3164500/Schedule_I/" target="_blank" rel="noopener noreferrer" className="inline-link">Schedule I</a> or some other incremental game, trying new restaurants, occasionally visiting Boston, and planning some trips to Asia.</p>
          </section>
        )}
