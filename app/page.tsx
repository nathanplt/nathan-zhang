      ...
      <main className="tab-content" role="main">
        {activeTab === 'overview' && (
          <section className="about">
            <p>Hey! I'm Nathan, a CS undergrad at UCLA w/ roots in NJ. I'm broadly interested in computer systems and making things fast - right now, obssessing over C++, parallel & distributed computing, and AI acceleration. If you've got good resources or interesting projects or also just passionate in similar things, please reach out!</p>
            <p>I'm currently developing ground station software for <a href="https://elfin.igpp.ucla.edu/" target="_blank" rel="noopener noreferrer" className="inline-link">UCLA's ELFIN CubeSat</a>. Spent the past year working on data infrastructure at <a href="https://www.capitalone.com" target="_blank" rel="noopener noreferrer" className="inline-link">Capital One</a> and fine-tuning reasoning models at <a href="https://scale.com" target="_blank" rel="noopener noreferrer" className="inline-link">Scale AI</a>. I'll be joining <a href="https://www.citadel.com/" target="_blank" rel="noopener noreferrer" className="inline-link">Citadel</a> as a SWE intern for Summer 2026 and <a href="https://research.google/pubs/large-scale-cluster-management-at-google-with-borg/" target="_blank" rel="noopener noreferrer" className="inline-link">Google</a> a SWE intern for Fall 2026.</p>
            <p>Outside of all that, I'm watching <a href="https://myanimelist.net/anime/40748/Jujutsu_Kaisen" target="_blank" rel="noopener noreferrer" className="inline-link">JJK</a>, trying new restaurants (Beli profile needs work), and planning some fun trips!</p>
          </section>
        )}
